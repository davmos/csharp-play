namespace Play.WindowsServiceControlApi
{
    ...
    public static class Win32ServiceControl
    {
        [DllImport("advapi32.dll", SetLastError = true)]
        public static extern Win32ServiceControlHandle OpenSCManager(
            string lpMachineName, 
            string lpSCDB, 
            SCM_ACCESS scParameter);
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Unicode, SetLastError = true, EntryPoint = "ChangeServiceConfig2")]
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Unicode, EntryPoint = "ChangeServiceConfig2")]
        ...
        public struct SERVICE_DESCRIPTION { public string lpDescription; }
